...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const sora2apiImageModels = [
    ...
    { id: 'gpt-image-2', descZh: '图生图/文生图', descEn: 'Image-to-image / Text-to-image', size: '1024×1024' },
  ];
        ...
        <div className="flex-1 overflow-y-auto bg-white dark:bg-gray-900 p-10 text-gray-900 dark:text-gray-100">
            ...
            <div className="space-y-10 max-w-3xl">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                  ...
                  <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-2">
                      <span className="text-sm text-gray-700 dark:text-gray-200">{t('历史记录', 'History')}</span>
                    </div>
                    <button
                      ...
                      title={t('在主页显示历史记录按钮', 'Shows the History button in the top bar')}
                    >
                      <div
                        className={`bg-white w-4 h-4 rounded-full shadow-md transform transition-transform duration-300 ${
          ...
          {activeTab === 'data' && (
            <div className="space-y-10 max-w-3xl">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t(
                    '一键下载会在该目录下自动创建历史记录文件夹。',
                    'Bulk download will create a history folder inside this directory.'
                  )}
                </p>
                <div className="flex flex-wrap items-center gap-3">
                  <button
          ...
          {activeTab === 'about' && (
            <div className="flex flex-col items-center gap-8 max-w-4xl mx-auto py-6 text-center">
              <div className="w-40 h-24 rounded-2xl overflow-hidden shadow-xl bg-transparent flex items-center justify-center">
                <img
                  src="/wuniao.png"
                  alt="项目封面"
              ...
              <div className="space-y-3">
                <h2 className="text-4xl font-bold text-gray-900 dark:text-white">昼夜交互科技</h2>
                <button
                  type="button"
                ...
                >
                  ...
                  <p className="text-base text-gray-600 dark:text-gray-300 max-w-2xl leading-relaxed">
                    ...
                    内置历史记录追踪、可视化网格与分栏聊天，并提供开发者开关、快捷模型切换和本地持久化能力，帮助你高效迭代创意和脚本。
                  </p>
              </div>
